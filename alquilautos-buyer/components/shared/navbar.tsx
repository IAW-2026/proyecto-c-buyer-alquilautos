      ...
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-6 text-sm text-[var(--navbar-text)]">
          <nav className="flex items-center gap-6">
            <Link href="/dashboard" className="font-semibold text-[var(--navbar-text)]">
              Explorar
            </Link>
            <Link href="/reservas" className="text-[var(--navbar-text)]">
              Mis reservas
            </Link>
            <Link href="/perfil" className="text-[var(--navbar-text)]">
              Mi perfil
            </Link>
            <Link href="/favoritos" className="flex items-center gap-2 font-semibold text-[var(--navbar-text)]">
            ...
            {isAdmin && (
              <Link
                href="/admin"
                className="inline-flex h-8 items-center justify-center rounded-full bg-[var(--color-primary-300)] px-4 text-xs font-semibold text-white transition hover:bg-[var(--color-primary-200)]"
              >
                Admin panel
              </Link>
            )}
